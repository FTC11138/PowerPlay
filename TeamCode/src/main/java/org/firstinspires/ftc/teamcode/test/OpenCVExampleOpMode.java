...
//        avgA = (int) Core.mean(RectA_Y).val[0];
        ...
        Imgproc.rectangle( // rings
                ...
                new Point(Constants.leftBoundary,600), // First point which defines the rectangle
                new Point(Constants.rightBoundary,800), // Second point which defines the rectangle
